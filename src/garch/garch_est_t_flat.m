function [Theta, accept] = garch_est_t_flat(r, theta0, nIter, nDiscard)
% [Theta, accept] = garch_est_t_flat(r, theta0, nIter, nDiscard) simulates
% from the posterior distribution of the GARCH-t model.
%
...
% Date:   May 9, 2014
    ...
    sigmaSq0 = var(r);
    kernel = @(theta) ...
        garch_like_t(r, sigmaSq0, ...
        theta(1), theta(2), theta(3), theta(4), theta(5)) + ...
        garch_prior_flat_t(theta(1));
