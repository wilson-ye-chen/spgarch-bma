function [sigmaPred, nuPred, muPred, predLike] = garch_pred_t( ...
    r, funEst, winEst, intEst, sdTol, iStart, iEnd)
% [sigmaPred, nuPred, muPred, predLike] = garch_pred_t(r, funEst, winEst, ...
% intEst, sdTol, iStart, iEnd) computes one-step-ahead forecasts and the
% log-predictive-likelihoods of the GARCH-t model.
%
