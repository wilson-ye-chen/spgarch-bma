function [logLike sigmaIn sigmaFore] = gas_like_t( ...
    r, sigmaSq0, nu, mu, omega, alpha1, alpha2, beta)
% [logLike sigmaIn sigmaFore] = gas_like_t(r, sigmaSq0, nu, mu, omega, ...
% alpha1, alpha2, beta) computes the log-likelihood of the GAS-t model.
%
...
% Date:   May 4, 2014
    ...
    a = r - mu;
    sigmaSq = gas_sigmasq_t(a, sigmaSq0, nu, omega, alpha1, alpha2, beta);
