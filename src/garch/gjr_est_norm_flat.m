function [Theta, accept] = gjr_est_norm_flat(r, theta0, nIter, nDiscard)
% [Theta, accept] = gjr_est_norm_flat(r, theta0, nIter, nDiscard) simulates
% from the posterior distribution of the GJR-GARCH-Normal model.
%
...
% Date:   February 8, 2014
    ...
    % Log-posterior
    sigmaSq0 = var(r);
    kernel = @(theta)gjr_like_norm( ...
        r, sigmaSq0, theta(1), theta(2), theta(3), theta(4), theta(5));
