function [Sigma, xNif, YNif, accRate, Chain] = gjr_batest_t_flat(Set, iSet)
% [Sigma, xNif, YNif, accRate, Chain] = gjr_batest_t_flat(Set, iSet)
%
...
% Date:   February 22, 2016
    ...
    for i = 1:nBat
        ...
        [Theta, accept] = gjr_est_t_flat(r, theta0, nIter, nDiscard);
        
        % Compute estimated conditional standard deviations
        sigmaSq0 = var(r);
        Sigma(:, i) = gjr_avesigma_t(Theta, r, sigmaSq0);
        
        % Evaluate the estimated news impact function
        YNif(:, i) = gjr_avenif_t(xNif, Theta);
