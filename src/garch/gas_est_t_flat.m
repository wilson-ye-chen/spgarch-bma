function [Theta, accept] = gas_est_t_flat(r, theta0, nIter, nDiscard)
% [Theta, accept] = gas_est_t_flat(r, theta0, nIter, nDiscard) simulates
% from the posterior distribution of the GAS-t model.
%
