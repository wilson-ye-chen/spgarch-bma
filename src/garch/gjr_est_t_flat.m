function [Theta, accept] = gjr_est_t_flat(r, theta0, nIter, nDiscard)
% [Theta, accept] = gjr_est_t_flat(r, theta0, nIter, nDiscard) simulates
% from the posterior distribution of the GJR-GARCH-t model.
%
