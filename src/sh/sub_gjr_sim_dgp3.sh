#!/bin/bash
#
# Usage: sub_gjr_sim_dgp3.sh start end
# Purpose:
# Submit a batch of jobs for the simulation study of the GJR-t model.
...
OUTNAME=/project/symbolic/out/spline/sim_gjr/dgp3/gjr_dgp3_
PROJECT=symbolic
JOBNAME=gjr_dgp3_
WALLTIME=1:00:00
NCPUS=1
...
do
    cmd="matlab -r \" \
        ...
        try, gjr_sim_job('$DATAFILE', '$OUTNAME$i.mat', '$i'), \
